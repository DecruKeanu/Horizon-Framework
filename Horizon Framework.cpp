...
{
	{
		TextWriter basicWriter("BasicFile.txt");
	...
	{
		TextReader basicReader("BasicFile.txt");
...
{
	{
		TextWriter regexWriter("Regex/Lesson1.txt");
	...
	{
		TextReader regexReader("Regex/Lesson1.txt");
